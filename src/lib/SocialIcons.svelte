...
<div class="flex space-x-3 {className}">
    ...
    <a 
        ...
        target="_blank" 
        rel="noopener noreferrer"
        class="text-gray-600 hover:text-blue-500 transition-colors duration-200 p-2 rounded-md hover:bg-gray-100"
        title="X (@NicoKrauseX)"
    >
        <svg class="{size}" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
    ...
    <a 
        ...
        target="_blank" 
        rel="noopener noreferrer"
        class="text-gray-600 hover:text-blue-700 transition-colors duration-200 p-2 rounded-md hover:bg-gray-100"
