<script>
	...
	import { isWebAuthnAvailable, isPlatformAuthenticatorAvailable } from '$lib/identity/webauthn-identity.js';
				...
				<div class="flex flex-col gap-2 sm:flex-row sm:items-center sm:gap-3">
					...
					<div class="flex items-center gap-2">
						{#if webauthnAvailable && platformAuthenticator}
							<div class="flex items-center gap-1 text-xs text-green-700" title="Hardware security available">
