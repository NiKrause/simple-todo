...
<button
	...
	class="fixed right-6 bottom-6 z-[10000] flex h-16 w-16 items-center justify-center rounded-full bg-[#E91315] text-white shadow-2xl transition-all duration-300 hover:scale-110 hover:shadow-[0_20px_40px_rgba(233,19,21,0.4)] focus:ring-4 focus:ring-red-300 focus:outline-none border-2 border-white {showStorachaIntegration
		? 'rotate-12 scale-105'
		: 'hover:rotate-6'}"
...
>
	...
	<svg width="28" height="32" viewBox="0 0 154 172" fill="none" xmlns="http://www.w3.org/2000/svg" class="transition-transform duration-300">
