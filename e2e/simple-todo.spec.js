...
test.describe('Simple Todo P2P Application', () => {
  ...
  test('should show consent modal and proceed with P2P initialization', async ({ page }) => {
    ...
    await page.waitForSelector('h1', { hasText: 'Simple TODO Example' });
  ...
  test('should handle offline mode correctly', async ({ page }) => {
    ...
    await expect(page.locator('h1', { hasText: 'Simple TODO Example' })).toBeVisible();
  ...
  test('should display system toast notifications', async ({ page }) => {
    ...
    console.log(toastFound ? '✅ Toast notifications test completed' : '⚠️ No toast notifications found (may be expected)');
  });
